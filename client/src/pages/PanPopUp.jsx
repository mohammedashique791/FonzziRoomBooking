...
export default function PanPopUp({panSubmit, open, setOpen}) {
    ...
    const isButtonDisabled = pan.length !== 10;
    return (
        <div>
            ...
            {open && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80 overflow-y-auto no-scrollbar z-50">
                    ...
                    <div className="absolute bg-white rounded-xl p-6 w-1/3 h-3/6 min-w-md max-h-full p-20 overflow-y-scroll no-scrollbar z-70">
                            ...
                            <div className="mt-8">
                                <h1 className="text-2xl font-semibold">Submit PAN</h1>
                                <p className="mt-2 text-sm text-gray-600">Enter the Permanent Account Number (PAN) of the person paying. We're required to collect this info for international reservations in order to comply with Reserve Bank of India (RBI) regulations</p>

                                <div className="relative border mt-3 rounded-lg border-black mt-5"><input  onChange={e => setpan(e.target.value)} type="text" maxLength='10' placeholder="PAN" className="border-none outline-none" />
                                ...
                                <div className="mt-14 text-xs">
                                    <p class>By continuing, I certify that the PAN I entered belongs to the person paying for this reservation and that I have permission to share their information.</p>
                                </div>
                                <div className="mt-5">
                                    <hr />
                                </div>
                            ...
                            <div className="mt-10 flex justify-between px-6 items-center    ">
                                ...
                                <button onClick={panSubmit} disabled={isButtonDisabled} className={classDecider()}>Submit</button>
                            </div>
                    </div>
                </div>
